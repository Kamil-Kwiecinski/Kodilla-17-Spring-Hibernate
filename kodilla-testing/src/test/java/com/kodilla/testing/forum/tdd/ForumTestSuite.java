...
public class ForumTestSuite {
    ...
    class TestPosts {
        @Test
        void testAddPost() {
            System.out.println("testAddPost is running...\n");
            //Given
        ...
        @Test
        void testGetPost() {
            System.out.println("testGetPost is running...\n");
            //Given
            ForumUser forumUser = new ForumUser("mrsmith", "John Smith");
        ...
        void testRemovePostNotExisting() {
            System.out.println("testRemovePostNotExisting is running...\n");
            //Given
            ForumUser forumUser = new ForumUser("mrsmith", "John Smith");
            ForumPost thePost = new ForumPost("Hello everyone, this is my first contribution here.", "mrsmith");
        ...
        @Test
        void testRemovePost() {
            System.out.println("testRemovePost is running...\n");
            //Given
            ForumUser forumUser = new ForumUser("mrsmith", "John Smith");
            ForumPost thePost = new ForumPost("Hello everyone, this is my first contribution here.", "mrsmith");
            forumUser.addPost(thePost.getAuthor(), thePost.getPostBody());
    ...
    class TestComments {
        @Test
        void testAddComment() {
            System.out.println("testAddComment is running...\n");
            //Given
            ForumUser forumUser = new ForumUser("mrsmith", "John Smith");
            ForumPost thePost = new ForumPost("Hello everyone, this is my first contribution here.", "mrsmith");
        ...
        @Test
        void testGetComment() {
            System.out.println("testGetComment is running...\n");
            //Given
            ForumUser forumUser = new ForumUser("mrsmith", "John Smith");
            ForumPost thePost = new ForumPost("Hello everyone, this is my first contribution here.", "mrsmith");
        ...
        void testRemoveCommentNotExisting() {
            System.out.println("testRemoveCommentNotExisting is running...\n");
            //Given
            ForumUser forumUser = new ForumUser("mrsmith", "John Smith");
            ForumPost thePost = new ForumPost("Hello everyone, this is my first contribution here.", "mrsmith");
            ForumComment theComment = new ForumComment(thePost, "Thank you for all good words!", "mrsmith");
        ...
        void testRemoveComment() {
            System.out.println("testRemoveComment is running...\n");
            //Given
            ForumUser forumUser = new ForumUser("mrsmith", "John Smith");
            ForumPost thePost = new ForumPost("Hello everyone, this is my first contribution here.", "mrsmith");
            ForumComment theComment = new ForumComment(thePost, "Thank you for all good words!", "mrsmith");
